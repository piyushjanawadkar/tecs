...
public class ASMTranslatorImpl implements ASMTranslator {
    ...
    private static final ImmutableMap<ParsedLine.LineType, ASMTranslator> generatorsByType =
            ImmutableMap.<ParsedLine.LineType, ASMTranslator>builder()
                    ...
                    .put(ParsedLine.LineType.COMMAND_ADD, new ArithmeticLogicOpASMTranslator(BINARY_OP_ASM_SEQUENCE, "+"))
                    .put(ParsedLine.LineType.COMMAND_SUB, new ArithmeticLogicOpASMTranslator(BINARY_OP_ASM_SEQUENCE, "-"))
                    .put(ParsedLine.LineType.COMMAND_NEG, new ArithmeticLogicOpASMTranslator(UNARY_OP_ASM_SEQUENCE, "-"))

                    .put(ParsedLine.LineType.COMMAND_AND, new ArithmeticLogicOpASMTranslator(BINARY_OP_ASM_SEQUENCE, "&"))
                    .put(ParsedLine.LineType.COMMAND_OR, new ArithmeticLogicOpASMTranslator(BINARY_OP_ASM_SEQUENCE, "|"))
                    .put(ParsedLine.LineType.COMMAND_NOT, new ArithmeticLogicOpASMTranslator(UNARY_OP_ASM_SEQUENCE, "!"))
